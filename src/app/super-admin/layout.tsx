...
export default function SuperAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-[#ededed] font-sans selection:bg-neutral-800 selection:text-white flex">
      ...
      {/* Sidebar - Dense, editorial, monochrome */}
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 border-b border-white/[0.05] bg-[#000000]/80 backdrop-blur-md sticky top-0 z-40 flex items-center px-6 justify-between shrink-0">
